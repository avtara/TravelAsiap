                    ...
                    <a class="header-brand" href="<?php echo base_url();?>">
                        ...
                        <div class="d-flex order-lg-2 ml-auto">
                            <div class="nav-item d-none d-md-flex">
                                <a href="fb.com" class="btn btn-secondary">Secondary</a>
                            </div>
                            <div class="nav-item d-none d-md-flex">
                                <a href="twitter.com" class="btn btn-primary">Primary</a>
                            </div>
                        </div>
                      ...
                      ?></strong>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <form action="<?php echo site_url('Home/user_booking/') action="<?php echo site_url('Home/user_booking/') ?>" method="get" accept-charset="utf-8">
